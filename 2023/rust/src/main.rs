...
fn main() {
    ...
    println!("Day 3 part 1: {}", hday_03::part_1(DAY_03_INPUT, &mut [0u8; 100000]));
    println!("Day 3 part 2: {}", hday_03::part_2(DAY_03_INPUT, &mut [0u8; 100000]));
    println!("Day 4 part 1: {}", hday_04::part_1(DAY_04_INPUT));
    println!("Day 4 part 2: {}", hday_04::part_2(DAY_04_INPUT, &mut [0u8; 100000]));
    println!("Day 5 part 1: {}", hday_05::part_1(DAY_05_INPUT, &mut [0u8; 100000]));
    println!("Day 5 part 2: {}", hday_05::part_1(DAY_05_INPUT, &mut [0u8; 100000]));
}
